        ...
        switch ($ruleName) {
            ...
            case 'min':
                if ($value !== null && $value !== '') {
                    if(is_string($value)) {
                        ...
                        if($value < (int)$param) {
                            return $customMessage ?? "Il valore {$field} non può essere minore di {$param}";
                        }
                    }
                }
                break;
            ...
            case 'max':
                if ($value !== null && $value !== '') {
                    if(is_string($value)) {
                        ...
                        if($value > (int)$param) {
                            return $customMessage ?? "Il valore {$field} non può maggiore di {$param}";
                        }
                    }
                }
                break;
            ...
            case 'datetime':
                if ($value !== null && $value !== '' && !strtotime($value)) {
                    return $customMessage ?? "Il campo {$field} deve contenere una data valida";
                }
                break;
